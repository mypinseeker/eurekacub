...
import type { DerivativePuzzleData, PositionSample, Phase } from './types'
...
function parsePuzzleData(puzzle: Record<string, unknown>): DerivativePuzzleData {
...
function generateDefaultCurve(): number[] {
  const points: number[] = []
  const n = 100
  for (let i = 0; i <= n; i++) {
    const t = i / n
...
function sampleTarget(curve: number[], tNorm: number): number {
